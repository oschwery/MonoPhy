...
```
At this point, the package requires the input tree to be rooted and fully resolved.
[enter data file requirements here]
...
```{r}
GetIntruderTips(solution1, taxa="Erica", taxlevels=2)  # get list of all species that cause issues for the monophyly of the subfamily Erica
```
[FIX THIS]
...
```
### 3.4 Plotting ###
Needless to say, the most intuitive way to get an impression of how many issues there are in 
