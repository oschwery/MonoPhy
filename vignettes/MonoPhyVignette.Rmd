...
```{r, eval=FALSE}
PlotMonophyly(solution0, Ericactree, plot.type='monophyly', ladderize=TRUE)
```
...
```{r, eval=FALSE}
PlotMonophyly(solution1, Ericactree, taxlevels=2, plot.type='taxonomy')
```
...
```{r, eval=FALSE}
PlotMonophyly(solution1, Ericactree, taxlevels=2, plot.type='monoVStax') 
```
...
```{r, eval=FALSE}
PlotMonophyly(solution1, Ericactree, taxlevels=1, plot.type='intruders', monocoll=TRUE)
```
...
```{r, eval=FALSE}
PlotMonophyly(solution0, Ericactree, taxlevels=1, plot.type='monophyly', monocoll=TRUE, ladderize=TRUE,
